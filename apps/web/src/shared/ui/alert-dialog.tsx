...
function AlertDialogHeader({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn('flex flex-col gap-2 pr-2 text-center sm:text-left', className)} {...props} />
  )
}
