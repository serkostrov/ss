...
type CabinetNotificationsNavProps = {
  onNavigate?: () => void
}

export function CabinetNotificationsNav({ onNavigate }: CabinetNotificationsNavProps) {
  const { profile } = useAuth()
  const enabled = profile?.status === 'confirmed'
